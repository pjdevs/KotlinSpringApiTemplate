...
class RandomVideoRepository : VideoRepository {
    private val videos = arrayOf(
        Video(VideoId(0), VideoPlatform.YOUTUBE, "hbHgIzIbzmQ", "Micode"),
        Video(VideoId(1), VideoPlatform.YOUTUBE, "sB_zRkqnfd0", "Yolo"),
        Video(VideoId(2), VideoPlatform.YOUTUBE, "oVHpiQdd4iI", "Test"),
    )
