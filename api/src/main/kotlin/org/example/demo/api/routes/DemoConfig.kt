...
import org.example.demo.infra.persistence.JpaUserRepository
...
import org.example.demo.infra.persistence.UserJpaRepository
...
class DemoConfig {
    ...
    @Bean
    fun userRepository(jpaRepository: UserJpaRepository): UserRepository = JpaUserRepository(jpaRepository)
}